...
<body>
	...
	<div class="esconder">
		...
		<section class="corpo">
			...
			$listagem = mysqli_query($conexao,  "SELECT * FROM coletar where coleta = 0 and referencia > 0 and quantidade > 0 and fabricante = '$fab'");
			...
			<table class="table table-condensed">
				...
				<tbody>
					...
					$listagem = mysqli_query($conexao, "SELECT * FROM diferenca where fabricante = '$fab'");
