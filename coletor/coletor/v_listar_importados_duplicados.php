...
<body>
   ...
   <section class="corpo">
    ...
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
        <h1 class="display-4">Produtos importados com referência duplicada</h1>
        <p class="lead">Produtos cadastrados duplicados</p>
      </div>
    </div>
    <!-- fim da header -->
    ...
    $listagem = mysqli_query($conexao,  "SELECT descricao, referencia, COUNT(*) AS qtd_duplicados
    FROM coletar
    WHERE referencia <> 0
    GROUP BY referencia
    HAVING COUNT(*) > 1");
