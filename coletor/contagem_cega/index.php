            ...
            <section class="tabela">
               ...
               <table class="table">
                  ...
                  <tr>
                     ...
                     <td><a  class="btn btn-info" href="php/finalizar.php?sessao=<?= $linha['id_sessao'] ?>" role="button" onclick="return confirm('Finalizar ?')" >Finalizar/bloquear</a></td>
                     <?php }else{ ?>
