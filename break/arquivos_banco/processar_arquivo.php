...

{
    ...
    else
    {
        ...
        $listage = mysqli_query($conexao, "SELECT referencia, quantidade, data_hora from vendas ;");
          ...
          //  echo "<br>";
...

            {
...

                {
                    ...
                    $listage1 = mysqli_query($conexao, "SELECT min(id), hora FROM coletor_importar LIMIT 1;");
...

                    {
                        ...
                        if ($hora_venda > $hora_inicio)
                        {
                            ...
                            $result_usuario = "UPDATE vendas SET retirar = 1 AND data_hora > '$hora_inicio';";
