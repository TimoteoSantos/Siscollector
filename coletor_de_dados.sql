...
--
-- Host: 127.0.0.1
-- Tempo de geração: 15-Fev-2021 às 16:38
...
(1, 'admin', 'zerou o sistema', '2021-02-15 16:38:09');
...
INSERT INTO `config` (`id`, `arquivo`, `conf`, `camera`, `tempo`, `diferenca`, `estoque_loja`, `sessao`, `vendas_sim`) VALUES
(3, '/util', 1, NULL, NULL, 0, 0, 0, 0),
(9, NULL, 3, NULL, 30000, 0, 0, 0, 0);
...
(1, 7898300742019, 'FIBRA SINTETICA SIMONE HAIR TRANCA COR', 1);
