<?php
	...
	//produto nao coletado mas tinha no estoque
	$result_transacoes = "SELECT * FROM coletar where coleta = 0 and referencia > 0 and quantidade > 0";
	...
	while($row_transacoes = mysqli_fetch_assoc($resultado_trasacoes)){
		...
		$html .= '<td class=bordas style="text-align:center;" >'. 'Não coletado'. "</td>";
